...
for category in categories:
    ...
    model.save(os.path.join(save_dir, f"model_{safe_category}.h5"))
    joblib.dump(scaler_X, os.path.join(save_dir, f"scaler_X_{safe_category}.pkl"))
    joblib.dump(scaler_y, os.path.join(save_dir, f"scaler_y_{safe_category}.pkl"))
